...
const Chatbot = () => {
  ...
  const faqList = [
    ...
    { 
      question: "What is 5G?", 
      answer: "5G is the fifth generation of mobile telecommunications technology, offering higher speeds and more reliable connections than previous generations."
    },
    { 
      question: "How can I check my balance?", 
      answer: "To check your balance, dial *123# or use the official mobile app."
    },
    { 
      question: "What is the difference between 3G and 4G?", 
      answer: "3G offers speeds up to 2 Mbps, while 4G can offer speeds up to 100 Mbps, providing faster internet access and smoother video calls."
    },
    { 
      question: "How can I activate a data plan?", 
      answer: "To activate a data plan, dial *111# and select the appropriate data plan option, or visit the nearest store."
    },
    { 
      question: "What is roaming?", 
      answer: "Roaming allows you to use your mobile phone to make calls and use data when traveling outside your home network coverage area."
    },
    { 
      question: "How can I recharge my account?", 
      answer: "To recharge your account, you can use online platforms like mobile banking apps, third-party recharge apps, or visit a retail shop."
    },
    { 
      question: "What should I do if I lose my phone?", 
      answer: "If you lose your phone, immediately contact customer support to block your SIM card and prevent unauthorized usage."
    },
    { 
      question: "What is mobile hotspot?", 
      answer: "A mobile hotspot allows you to share your phone's mobile data with other devices like laptops or tablets by converting it into a Wi-Fi network."
    }
  ...
  const sendMessage = async (text) => {
    ...
    if (text.toLowerCase() === "hi") {
      ...
      setMessages([...newMessages, { text: "Thank you! Reply 'Hi' to start a conversation.", sender: "bot" }]);
  ...
  const submitTicket = async () => {
    ...
    // Get the current date and format it to 'YYYY-MM-DD HH:mm:ss'
    const currentDate = new Date();
    const formattedDate = currentDate.toISOString().slice(0, 19).replace("T", " "); // Convert to 'YYYY-MM-DD HH:mm:ss'

    const newTicket = {
        created_at: formattedDate, // Correct format
        employ_id: 1, // Default value since employ_id is required
        issue: ticket.ticketDescription,
        status: "Open",
        updated_at: null, // Explicitly setting NULL
        user_id: 6
    };
